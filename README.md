...
- **Réglages hérités de la V7, à la demande de Hadrien (17 septembre 2026)** : polices agrandies (nom 15 px / interligne 16, fonction 12,5 px / interligne 14), 22 px entre le texte et le visuel, CTA de 17 px de diamètre (le fichier a un CTA de 18,35 px ; 15 px du 17 septembre, +2 px le 18 septembre), **bas du cercle aligné sur le bas du L du logo LEKO** de la tuile (à 125,8 px du haut du visuel) et même écart au bord droit qu'au bord bas du visuel (17 px), réglage du 18 septembre. Hauteur totale 208 px (222 avec seconde ligne). Rendu vérifié dans Chromium : glyphes du texte à x = 0, lignes de base 25 et 39,5, visuel à (0, 65) en 319 × 143, tuile à (324, 65) en 44 × 143.
...
|---|---|---|---|
| `visual-robotics-3@3x.png` / `.jpg` | 319 × 143 | ×3 (957 × 429) | Visuel par défaut : fenêtre `[68,31, 95,64]–[706,83, 380,64]` du plan 14 (même cadrage que les plans 06/07), Lanczos depuis la photo 2094 × 792, angles transparents 6,8 px, CTA 17 px ombré intégré, bas du cercle à y = 377,5 @3x (bas du L du logo), à 51 px @3x des bords droit et bas. |
...
| `cta-shadow-2@3x.png` | — | ×3 (136 × 136) | CTA 17 px avec son ombre (échelle 1,39 du fichier), posé par le générateur à (812, 285) sur les visuels personnalisés. |
| `visual-robotics@3x.*`, `visual-robotics-2@3x.*`, `cta-shadow@3x.png` (CTA 15 px), `logo-tile-tall-black/white@4x.png` (plan 15, logo en haut), `visual-shadow-robotics@3x.*`, `visual-shadow-frame@3x.png` (plan 15 avec ombre), `logo-tile-side-*@4x.png` (plan 06) | — | — | Conservés en ligne pour les signatures déjà collées, ne rien supprimer ni modifier. |
...
- 18 septembre 2026, 15 h 45 : diamètre du CTA porté à 17 px, mêmes règles d'alignement.
